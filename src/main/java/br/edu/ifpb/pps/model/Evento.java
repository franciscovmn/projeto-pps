...
public class Evento {
    ...
    private LocalDateTime dataLimiteSubmissao;
    ...
    public Evento(String nome, String cidade, String periodo, LocalDateTime dataLimiteSubmissao, CategoriaEvento categoriaEvento) {
        this.nome = nome;
        this.cidade = cidade;
